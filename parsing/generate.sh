...
# US (less useful: Steven, Emily, Trevor)
run_safe $CHI $SOURCE_DIR/US/Bloom70_Peter/*.$SOURCE_EXT > $TARGET_DIR/Peter.$TARGET_EXT &
run_safe $CHI $SOURCE_DIR/US/Braunwald_Laura/*.$SOURCE_EXT > $TARGET_DIR/LauraB.$TARGET_EXT & 
...
# UK (less useful: Abigail, Benjamin, Betty, Cruttenden, Darren, Debbie, Ella, Ellen, Elspeth, Frances, Gary, Gavin, Geoffrey, Gerald, Harriet, Iris, Jack, Jane, Jason, Jonathan, LauraW, Lee, Lucy, Martin, Nancy, Neil, Olivia, Penny, Rosie, Samantha, Sean, Sheila, Simon, Stella, Tony)
...
run_safe $MOT $SOURCE_DIR/US/Suppes_Nina/*.$SOURCE_EXT > $TARGET_DIR/Nina.$TARGET_EXT &
